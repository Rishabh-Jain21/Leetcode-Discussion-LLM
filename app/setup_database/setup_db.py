...
def create_tables():
    ...
    # ---------------------------------------------------------------
    # 1. raw_short_discussions  (replaces data.json / data_merged.json)
    ...
    cursor.execute(
        """
        CREATE TABLE IF NOT EXISTS raw_short_discussions (
    ...
    # ---------------------------------------------------------------
    # 2. updated_raw_short_discussions  (replaces updated.json)
    ...
    cursor.execute(
        """
        CREATE TABLE IF NOT EXISTS updated_raw_short_discussions (
            topic_id    INTEGER PRIMARY KEY,
            title       TEXT,
            slug        TEXT,
            summary     TEXT,
    ...
    cursor.execute(
        ...
        ON raw_short_discussions(updated_at)
    """
    )
